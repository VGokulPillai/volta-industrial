...
req = urllib.request.Request(
    ...
    data=json.dumps({"endpoint": "projects/volta-maintenance/branches/production/endpoints/primary"}).encode(),
    method="POST",
...
conn = psycopg2.connect(
    host="ep-steep-moon-d2x11wbr.database.us-east-1.cloud.databricks.com", port=5432, dbname="databricks_postgres",
